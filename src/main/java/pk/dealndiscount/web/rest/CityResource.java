...
/**
 * REST controller for managing {@link pk.dealndiscount.domain.City}.
 */
@RestController
...
public class CityResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<CityDTO>> getAllCities(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTENDEDUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXTENDEDUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXTENDEDUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXTENDEDUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXTENDEDUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXTENDEDUSER actions', async () => {
      const arg = 42666;

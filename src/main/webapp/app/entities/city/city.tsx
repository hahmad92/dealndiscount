  ...
  return (
    <div>
      <h2 id="city-heading" data-cy="CityHeading">
        <Translate contentKey="dealNdiscountApp.city.home.title">Cities</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dealNdiscountApp.city.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/city/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dealNdiscountApp.city.home.createLabel">Create new City</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cityList && cityList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dealNdiscountApp.city.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('cityName')}>
                  <Translate contentKey="dealNdiscountApp.city.cityName">City Name</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dealNdiscountApp.city.home.notFound">No Cities found</Translate>
            </div>
          )
        )}
      </div>

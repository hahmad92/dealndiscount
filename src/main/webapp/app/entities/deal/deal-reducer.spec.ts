...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './deal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEAL actions', async () => {
      const arg = 42666;

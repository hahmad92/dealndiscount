...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bank.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANK actions', async () => {
      const arg = 42666;

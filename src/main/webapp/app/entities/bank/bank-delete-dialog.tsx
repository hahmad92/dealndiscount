...
export const BankDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/bank' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="dealNdiscountApp.bank.delete.question">
        <Translate contentKey="dealNdiscountApp.bank.delete.question" interpolate={{ id: bankEntity.id }}>
